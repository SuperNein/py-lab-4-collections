...
class Simulation:
    ...
    def _choose_random_action(self) -> tuple[Callable, dict[str, Any]]:
        upd_actions: list[tuple[Callable, dict[str, Any]]] = [
            (self.remove_book, {"book": self._choose_random_book()}),
        ]
        return random.choice(self.__actions + upd_actions)
    ...
    def switch_book(
        ...
        return f"Switch {old_book} to {new_book}"
